...
| PRIM-0026 | User Data Backup-Restore Guard | Full-repair workflow backs up and restores user presets/data by default with explicit data-drop option | REQ-0025, REQ-0026 | All | E2E-VERIFIED |
| PRIM-0027 | Version Direction Guard | Update requires newer package and downgrade requires explicit older package with auditable invocation | REQ-0027, REQ-0028 | All | E2E-VERIFIED |
...
- Run WP checks: powershell -ExecutionPolicy Bypass -File .gov/workflow/wp_checks/check-WP-GOV-INSTALLER-001.ps1
- Proof artifacts: .product/build_target/tool_artifacts/wp_runs/WP-GOV-INSTALLER-001/

...
|-------------|-------|---------|-------------|--------|--------|
| REQ-0008 | MUST | ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§7.2 | Every artifact MUST carry sensitivity marking; markings propagate through composition and exports | All | IN-PROGRESS |
| REQ-0009 | MUST | ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§7.3 | Every layer and derived artifact MUST carry provenance (source, license, timestamp, cadence, lineage) | All | IN-PROGRESS |
| REQ-0010 | MUST | ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§8.1 | Immutable append-only audit trail of all analyst actions, exports, queries, alerts, collaboration, AI access | All | IN-PROGRESS |

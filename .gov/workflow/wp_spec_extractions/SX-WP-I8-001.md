...
|-------------|-------|---------|-------------|--------|--------|
| REQ-0900 | SHOULD | Ã‚Â§13.5 | Trade flow deviation detection vs historical baseline | I8 | IMPLEMENTED |
| REQ-0901 | SHOULD | Ã‚Â§13.5 | Infrastructure status deviation detection | I8 | IMPLEMENTED |
| REQ-0902 | SHOULD | Ã‚Â§13.5 | Regulatory regime change detection for active AOIs | I8 | IMPLEMENTED |
| REQ-0903 | MUST | Ã‚Â§13.5 | Deviation events emitted through standard Event model with context.deviation taxonomy | I8 | IMPLEMENTED |
| REQ-0904 | MUST | Ã‚Â§7.4.7 | constraint_node domains available in Scenario Workspace | I8 | IMPLEMENTED |

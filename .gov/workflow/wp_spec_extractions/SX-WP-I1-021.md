# SX-WP-I1-021 - Spec Extraction Snapshot
...
- Real Seam: CSS grid layout, collapse toggle affordance, footer grid integration — all direct code changes.
- User-Visible Win: All four panels always discoverable and reachable; collapsed panels have persistent toggles outside their own collapsed area; tray never overlays the map; midrange viewports degrade gracefully.
...
- Run WP checks: powershell -ExecutionPolicy Bypass -File .gov/workflow/wp_checks/check-WP-I1-021.ps1
- Proof artifacts: .product/build_target/tool_artifacts/wp_runs/WP-I1-021/

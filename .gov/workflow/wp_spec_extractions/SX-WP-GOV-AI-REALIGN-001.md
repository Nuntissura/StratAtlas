# SX-WP-GOV-AI-REALIGN-001 - Spec Extraction Snapshot
...
| PRIM-0053 | Audited MCP Execution Surface | Expose only governed MCP tools and execution paths with audit capture, refusal handling, and no raw-path or raw-database escape hatches | REQ-0700, REQ-0701, REQ-0702, REQ-0703, REQ-0704, REQ-0705, REQ-0706, REQ-0707, REQ-0708 | I6 | E2E-VERIFIED |
...
- Run WP checks: powershell -ExecutionPolicy Bypass -File .gov/workflow/wp_checks/check-WP-GOV-AI-REALIGN-001.ps1
- Proof artifacts: .product/build_target/tool_artifacts/wp_runs/WP-GOV-AI-REALIGN-001/

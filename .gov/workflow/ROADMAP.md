...
- Next correct task: return to `WP-GOV-SMOKE-001` for broader manual desktop scenario coverage against the expanded map-family surface, then decide whether release-prep governance or another UX/visual refinement packet is the higher-ROI next move.

...
| WP-I0-001 | I0 | Walking Skeleton Activation | Initial activation shell for bundle/audit/offline foundations and portability baseline | IN-PROGRESS | Codex | REQ-0100..REQ-0112, REQ-0017..REQ-0018 | `.gov/Spec/sub-specs/I0_walking_skeleton.md` | `.gov/workflow/wp_test_suites/TS-WP-I0-001.md` | 2026-03-06 | Activation shell exists, but normative recorder/state gaps remain; follow-on packet `WP-I0-002` is the current blocking implementation packet. |
| WP-I0-002 | I0 | Recorder Artifact and Context Snapshot Hardening | Authoritative recorder store, multi-asset bundle snapshots, and captured active context state | IN-PROGRESS | Codex | REQ-0008, REQ-0009, REQ-0010, REQ-0101..REQ-0112, REQ-0808 | `.gov/Spec/sub-specs/I0_walking_skeleton.md` | `.gov/workflow/wp_test_suites/TS-WP-I0-002.md` | 2026-03-06 | Active blocking product packet; spec extraction: .gov/workflow/wp_spec_extractions/SX-WP-I0-002.md; check script: .gov/workflow/wp_checks/check-WP-I0-002.ps1 |
| WP-I1-001 | I1 | Layer Time Replay Deterministic Export | Initial activation shell for layer/time/replay/performance contracts | IN-PROGRESS | Codex | REQ-0200..REQ-0212, REQ-0014..REQ-0016 | `.gov/Spec/sub-specs/I1_layers_time_replay.md` | `.gov/workflow/wp_test_suites/TS-WP-I1-001.md` | 2026-03-06 | Activation shell exists, but visible layer/label/budget surfaces remain incomplete; follow-on packet `WP-I1-002` is queued behind `WP-I0-002`. |
| WP-I1-002 | I1 | Workspace Surface Layer Catalog and Policy Labeling | Real workspace regions, visible artifact labels, layer metadata, and budget/degradation feedback | IN-PROGRESS | Codex | REQ-0011, REQ-0012, REQ-0014..REQ-0016, REQ-0200..REQ-0212, REQ-0804, REQ-0805 | `.gov/Spec/sub-specs/I1_layers_time_replay.md` | `.gov/workflow/wp_test_suites/TS-WP-I1-002.md` | 2026-03-06 | Next product recovery packet after `WP-I0-002`; spec extraction: .gov/workflow/wp_spec_extractions/SX-WP-I1-002.md; check script: .gov/workflow/wp_checks/check-WP-I1-002.ps1 |
| WP-I2-001 | I2 | Baseline Delta Briefing Bundle | Activation-shell scaffolding for baseline/delta and briefing export | BLOCKED | Codex | REQ-0300..REQ-0302 | `.gov/Spec/sub-specs/I2_baseline_delta_briefing.md` | `.gov/workflow/wp_test_suites/TS-WP-I2-001.md` | 2026-03-06 | Normative I2 delivery is paused until the I0/I1 recovery queue clears. |
| WP-I3-001 | I3 | Collaboration CRDT Session Replay | Activation-shell scaffolding for collaboration, conflict UX, and attribution replay | BLOCKED | Codex | REQ-0400..REQ-0403 | `.gov/Spec/sub-specs/I3_collaboration_crdt_replay.md` | `.gov/workflow/wp_test_suites/TS-WP-I3-001.md` | 2026-03-06 | Normative I3 delivery is paused until the I0/I1 recovery queue clears. |
| WP-I4-001 | I4 | Scenario Modeling Constraint Propagation | Activation-shell scaffolding for scenario fork, constraints, and export | BLOCKED | Codex | REQ-0500..REQ-0504 | `.gov/Spec/sub-specs/I4_scenario_modeling_constraints.md` | `.gov/workflow/wp_test_suites/TS-WP-I4-001.md` | 2026-03-06 | Normative I4 delivery is paused until the I0/I1 recovery queue clears. |
| WP-I5-001 | I5 | Query Builder Versioned Queries | Activation-shell scaffolding for compose/run/render/version query flows | BLOCKED | Codex | REQ-0600..REQ-0604 | `.gov/Spec/sub-specs/I5_query_builder_versioned_queries.md` | `.gov/workflow/wp_test_suites/TS-WP-I5-001.md` | 2026-03-06 | Normative I5 delivery is paused until the I0/I1 recovery queue clears. |
| WP-I6-001 | I6 | AI Gateway MCP Interface | Activation-shell scaffolding for policy-gated AI/MCP contracts | BLOCKED | Codex | REQ-0700..REQ-0708 | `.gov/Spec/sub-specs/I6_ai_gateway_mcp.md` | `.gov/workflow/wp_test_suites/TS-WP-I6-001.md` | 2026-03-06 | Normative I6 delivery is paused until the I0/I1 recovery queue clears. |
| WP-I7-001 | I7 | Context Intake First Domains | Activation-shell scaffolding for domain registry/correlation/offline capture | BLOCKED | Codex | REQ-0800..REQ-0810 | `.gov/Spec/sub-specs/I7_context_intake_first_domains.md` | `.gov/workflow/wp_test_suites/TS-WP-I7-001.md` | 2026-03-06 | Normative I7 delivery is paused until the I0/I1 recovery queue clears. |
| WP-I8-001 | I8 | Context Deviation Infrastructure Propagation | Activation-shell scaffolding for deviation events and scenario constraint-node propagation | BLOCKED | Codex | REQ-0900..REQ-0904 | `.gov/Spec/sub-specs/I8_context_deviation_infrastructure.md` | `.gov/workflow/wp_test_suites/TS-WP-I8-001.md` | 2026-03-06 | Normative I8 delivery is paused until the I0/I1 recovery queue clears. |
| WP-I9-001 | I9 | OSINT Economic Context Queries | Activation-shell scaffolding for curated OSINT, verification labels, and aggregate alerts | BLOCKED | Codex | REQ-1000..REQ-1003 | `.gov/Spec/sub-specs/I9_osint_economic_context_queries.md` | `.gov/workflow/wp_test_suites/TS-WP-I9-001.md` | 2026-03-06 | Normative I9 delivery is paused until the I0/I1 recovery queue clears. |
| WP-I10-001 | I10 | Strategic Game Modeling | Activation-shell scaffolding for game model, scenario tree, and experiment bundle guardrails | BLOCKED | Codex | REQ-1100..REQ-1113 | `.gov/Spec/sub-specs/I10_strategic_game_modeling.md` | `.gov/workflow/wp_test_suites/TS-WP-I10-001.md` | 2026-03-06 | Normative I10 delivery is paused until the I0/I1 recovery queue clears. |

...
| WP-I2-002 | I2 | Comparative Dashboard and Briefing Artifact Flow | Deterministic compare windows, context overlay dashboard, and labeled briefing artifact tied to bundle state | IMPLEMENTED | Codex | REQ-0300, REQ-0301, REQ-0302 | `.gov/Spec/sub-specs/I2_baseline_delta_briefing.md` | `.gov/workflow/wp_test_suites/TS-WP-I2-002.md` | 2026-03-06 | Passed `.gov/workflow/wp_checks/check-WP-I2-002.ps1`; proof: `.product/build_target/tool_artifacts/wp_runs/WP-I2-002/20260306_050212/`; user sign-off still pending for `E2E-VERIFIED`. |
| WP-I3-001 | I3 | Collaboration CRDT Session Replay | Activation-shell scaffolding for collaboration, conflict UX, and attribution replay | IN-PROGRESS | Codex | REQ-0400..REQ-0403 | `.gov/Spec/sub-specs/I3_collaboration_crdt_replay.md` | `.gov/workflow/wp_test_suites/TS-WP-I3-001.md` | 2026-03-06 | Activated as the current blocking packet after `WP-I2-002` proof; legacy 2026-03-05 shell evidence remains baseline only. |

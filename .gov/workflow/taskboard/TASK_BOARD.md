...
| WP-I9-001 | I9 | OSINT Economic Context Queries | Activation-shell scaffolding for curated OSINT, verification labels, and aggregate alerts | IN-PROGRESS | Codex | REQ-1000..REQ-1003 | `.gov/Spec/sub-specs/I9_osint_economic_context_queries.md` | `.gov/workflow/wp_test_suites/TS-WP-I9-001.md` | 2026-03-06 | Activated as the current blocking packet after `WP-I8-001` proof; prior 2026-03-05 shell evidence remains baseline only pending normative I9 delivery. |
| WP-I10-001 | I10 | Strategic Game Modeling | Activation-shell scaffolding for game model, scenario tree, and experiment bundle guardrails | BLOCKED | Codex | REQ-1100..REQ-1113 | `.gov/Spec/sub-specs/I10_strategic_game_modeling.md` | `.gov/workflow/wp_test_suites/TS-WP-I10-001.md` | 2026-03-06 | Roadmap order queues normative I10 delivery behind `WP-I9-001`. |

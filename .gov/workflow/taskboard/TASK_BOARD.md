...
| WP-I4-001 | I4 | Scenario Modeling Constraint Propagation | Activation-shell scaffolding for scenario fork, constraints, and export | IN-PROGRESS | Codex | REQ-0500..REQ-0504 | `.gov/Spec/sub-specs/I4_scenario_modeling_constraints.md` | `.gov/workflow/wp_test_suites/TS-WP-I4-001.md` | 2026-03-06 | Activated as the current blocking packet after `WP-I3-001` proof; legacy 2026-03-05 shell evidence remains baseline only. |
| WP-I5-001 | I5 | Query Builder Versioned Queries | Activation-shell scaffolding for compose/run/render/version query flows | BLOCKED | Codex | REQ-0600..REQ-0604 | `.gov/Spec/sub-specs/I5_query_builder_versioned_queries.md` | `.gov/workflow/wp_test_suites/TS-WP-I5-001.md` | 2026-03-06 | Roadmap order queues normative I5 delivery behind `WP-I4-001`. |
| WP-I6-001 | I6 | AI Gateway MCP Interface | Activation-shell scaffolding for policy-gated AI/MCP contracts | BLOCKED | Codex | REQ-0700..REQ-0708 | `.gov/Spec/sub-specs/I6_ai_gateway_mcp.md` | `.gov/workflow/wp_test_suites/TS-WP-I6-001.md` | 2026-03-06 | Roadmap order queues normative I6 delivery behind `WP-I4-001`. |
| WP-I7-001 | I7 | Context Intake First Domains | Activation-shell scaffolding for domain registry/correlation/offline capture | BLOCKED | Codex | REQ-0800..REQ-0810 | `.gov/Spec/sub-specs/I7_context_intake_first_domains.md` | `.gov/workflow/wp_test_suites/TS-WP-I7-001.md` | 2026-03-06 | Roadmap order queues normative I7 delivery behind `WP-I4-001`. |
| WP-I8-001 | I8 | Context Deviation Infrastructure Propagation | Activation-shell scaffolding for deviation events and scenario constraint-node propagation | BLOCKED | Codex | REQ-0900..REQ-0904 | `.gov/Spec/sub-specs/I8_context_deviation_infrastructure.md` | `.gov/workflow/wp_test_suites/TS-WP-I8-001.md` | 2026-03-06 | Roadmap order queues normative I8 delivery behind `WP-I4-001`. |
| WP-I9-001 | I9 | OSINT Economic Context Queries | Activation-shell scaffolding for curated OSINT, verification labels, and aggregate alerts | BLOCKED | Codex | REQ-1000..REQ-1003 | `.gov/Spec/sub-specs/I9_osint_economic_context_queries.md` | `.gov/workflow/wp_test_suites/TS-WP-I9-001.md` | 2026-03-06 | Roadmap order queues normative I9 delivery behind `WP-I4-001`. |
| WP-I10-001 | I10 | Strategic Game Modeling | Activation-shell scaffolding for game model, scenario tree, and experiment bundle guardrails | BLOCKED | Codex | REQ-1100..REQ-1113 | `.gov/Spec/sub-specs/I10_strategic_game_modeling.md` | `.gov/workflow/wp_test_suites/TS-WP-I10-001.md` | 2026-03-06 | Roadmap order queues normative I10 delivery behind `WP-I4-001`. |

...
| WP-I1-001 | I1 | Layer Time Replay Deterministic Export | Initial activation shell for layer/time/replay/performance contracts | IN-PROGRESS | Codex | REQ-0200..REQ-0212, REQ-0014..REQ-0016 | `.gov/Spec/sub-specs/I1_layers_time_replay.md` | `.gov/workflow/wp_test_suites/TS-WP-I1-001.md` | 2026-03-06 | Activation shell exists, but visible layer/label/budget surfaces remain incomplete; follow-on packet `WP-I1-002` is now the current blocking implementation packet. |
| WP-I1-002 | I1 | Workspace Surface Layer Catalog and Policy Labeling | Real workspace regions, visible artifact labels, layer metadata, and budget/degradation feedback | IN-PROGRESS | Codex | REQ-0011, REQ-0012, REQ-0014..REQ-0016, REQ-0200..REQ-0212, REQ-0804, REQ-0805 | `.gov/Spec/sub-specs/I1_layers_time_replay.md` | `.gov/workflow/wp_test_suites/TS-WP-I1-002.md` | 2026-03-06 | Current blocking product recovery packet after `WP-I0-002`; spec extraction: .gov/workflow/wp_spec_extractions/SX-WP-I1-002.md; check script: .gov/workflow/wp_checks/check-WP-I1-002.ps1 |

...
|--------|-------------|-----------|----------|--------|--------------|----------|
| DEP-001 | REQ-0800 | PRIM-0054 | Dependency | dependency graph | <command> | dependencies resolved and policy-compliant |
| UI-001 | REQ-0800 | PRIM-0054 | UI Contract | required UI contract | <test file> | required regions/modes and degraded states pass |
| FUNC-001 | REQ-0800 | PRIM-0054 | Functionality | golden flow | <test file> | golden flow passes deterministically |
| COR-001 | REQ-0800 | PRIM-0054 | Code Correctness | module contracts | <unit/integration> | invariant and regression checks pass |
| RED-001 | REQ-0800 | PRIM-0054 | Red Team / Abuse | misuse constraints | <security test> | abuse cases blocked and audited |
| EXT-001 | REQ-0800 | PRIM-0054 | Additional | perf/offline/reliability | <test> | budgets and resilience targets met |

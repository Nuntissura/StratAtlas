# TS-WP-I0-001 - Spec vs Code Test Suite
...
- Linked requirements: REQ-0100..REQ-0112, REQ-0017, REQ-0018 (desktop portability guardrails)
- Linked primitives: PRIM-0001, PRIM-0002, PRIM-0003, PRIM-0004
...
- Result: RETAINED BASELINE PROOF; packet superseded by `WP-I0-002`
- Blocking Failures: None
- Evidence Paths: `.product/build_target/tool_artifacts/wp_runs/WP-I0-001/20260306_003702/result.json`; `.product/build_target/tool_artifacts/wp_runs/WP-I0-001/20260306_003702/summary.md`
- Reviewer: Codex
- User Sign-off: N/A (`SUPERSEDED` by `WP-I0-002`)

## Automation Hook

- Command: powershell -ExecutionPolicy Bypass -File .gov/workflow/wp_checks/check-WP-I0-001.ps1
- Artifacts: .product/build_target/tool_artifacts/wp_runs/WP-I0-001/

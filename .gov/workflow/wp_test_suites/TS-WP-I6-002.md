...
|--------|-------------|-----------|----------|--------|--------------|----------|
| DEP-001 | REQ-0700 | PRIM-0052 | Dependency | dependency graph | <command> | dependencies resolved and policy-compliant |
| UI-001 | REQ-0700 | PRIM-0052 | UI Contract | required UI contract | <test file> | required regions/modes and degraded states pass |
| FUNC-001 | REQ-0700 | PRIM-0052 | Functionality | golden flow | <test file> | golden flow passes deterministically |
| COR-001 | REQ-0700 | PRIM-0052 | Code Correctness | module contracts | <unit/integration> | invariant and regression checks pass |
| RED-001 | REQ-0700 | PRIM-0052 | Red Team / Abuse | misuse constraints | <security test> | abuse cases blocked and audited |
| EXT-001 | REQ-0700 | PRIM-0052 | Additional | perf/offline/reliability | <test> | budgets and resilience targets met |

...
| PRIM-0032 | WP-I0-002 | REQ-0008, REQ-0009, REQ-0010, REQ-0101..REQ-0112, REQ-0808 | src/contracts/i0.ts; src/lib/backend.ts; src-tauri/src/lib.rs | src/lib/backend.test.ts; src/App.test.tsx; src-tauri/src/lib.rs (unit tests) | TypeScript, Tauri invoke, Rust persistence | PRIM-0033, PRIM-0034 | SPEC-MAPPED | 2026-03-06 |
| PRIM-0033 | WP-I0-002 | REQ-0008, REQ-0009, REQ-0010, REQ-0101..REQ-0112 | src/contracts/i0.ts; src/lib/backend.ts; src-tauri/src/lib.rs | src/lib/backend.test.ts; src-tauri/src/lib.rs (unit tests) | SHA-256 asset manifests, Rust recorder | PRIM-0032, PRIM-0034 | SPEC-MAPPED | 2026-03-06 |
| PRIM-0034 | WP-I0-002 | REQ-0101..REQ-0112, REQ-0808 | src/App.tsx; src/lib/backend.ts; src-tauri/src/lib.rs | src/App.test.tsx; src/lib/backend.test.ts | React state serialization, TypeScript contracts, Rust persistence | PRIM-0032, PRIM-0033 | SPEC-MAPPED | 2026-03-06 |

...
Linked Work Packet(s): WP-I9-001, WP-I9-002
Linked Requirements: REQ-1000..REQ-1003

## 1) UX Contract

- This slice delivers: curated OSINT ingestion, verification labels, aggregate-only alert semantics, context-threshold rules.
...
- Performance target: alerts and context-aware query updates remain within interaction budgets.
...
- Primary risk: source quality drift causing low-confidence signals to appear authoritative.

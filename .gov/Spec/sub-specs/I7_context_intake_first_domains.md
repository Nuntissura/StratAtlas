...
Linked Work Packet(s): WP-I7-001, WP-I7-002
Linked Requirements: REQ-0800..REQ-0810

## 1) UX Contract

- This slice delivers: domain registration contract, correlation model, context presentation, offline pre-cache behavior.
...
- Performance target: context toggles and AOI correlation updates remain interactive.
...
- Primary risk: context presented as causal evidence instead of correlated enrichment.

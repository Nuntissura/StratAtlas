...
- This slice delivers: scenario fork lifecycle, constraint graph editing, hypothetical entities, comparison/export.
...
- Performance target: fork/compare interactions maintain analyst feedback budget.
...
- Primary risk: constraint propagation creating inconsistent branch state.

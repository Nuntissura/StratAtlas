# I5 - Query Builder + Versioned Queries Sub-Spec

Date: 2026-03-05
Status: APPROVED
Iteration: I5
Parent Spec: .gov/Spec/stratatlas_spec_v1_2.md
Linked Work Packet(s): WP-I5-001, WP-I5-002
Linked Requirements: REQ-0600..REQ-0604

## 1) UX Contract

- This slice delivers: composable spatio-temporal query graph, ephemeral render layers, saved versioned query artifacts.
...
- Performance target: query compose/run/render remains responsive for target datasets.
...
- Primary risk: query graph ambiguity producing non-deterministic result sets.

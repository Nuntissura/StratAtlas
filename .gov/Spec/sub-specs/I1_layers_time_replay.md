...
- This slice delivers: stable UI regions, layer contract enforcement, replay timeline, deterministic exports, startup/state-change performance budgets.
...
- Performance target: 2D pan/zoom <=50ms, warm scrub <=250ms, cold scrub <=2.0s, export budgets per REQ-0209/0210.
...
- Primary risk: plugin sandbox bypass and performance regressions under dense layers.

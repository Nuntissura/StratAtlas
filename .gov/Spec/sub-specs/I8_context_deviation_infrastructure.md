...
Linked Work Packet(s): WP-I8-001, WP-I8-002
Linked Requirements: REQ-0900..REQ-0904

## 1) UX Contract

- This slice delivers: deviation event generation, taxonomy compliance, scenario constraint-node propagation.
...
- Performance target: deviation detection runs incrementally without blocking analyst navigation.
...
- Primary risk: false positives from seasonal/expected variance.

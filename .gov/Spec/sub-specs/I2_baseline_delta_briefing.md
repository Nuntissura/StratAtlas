...
Linked Work Packet(s): WP-I2-001, WP-I2-002, WP-I2-003
Linked Requirements: REQ-0300..REQ-0302

## 1) UX Contract

- This slice delivers: baseline reference windows, delta grid generation, comparative dashboard, briefing bundle workflow.
...
- Performance target: golden flow completion within analyst interaction budgets.
...
- Primary risk: false delta interpretation when baseline windows are too sparse.
